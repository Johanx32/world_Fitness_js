    ...
    @method('put')
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="telefono_Geren" class="form-control" id="telefono_Geren" value="{{ old('telefono_Geren', $gerente->telefono_Geren) }}"><br><br>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="identificacion_Usuario_FK" class="form-control" id="identificacion_Usuario_FK" value="{{ old('identificacion_Usuario_FK', $gerente->identificacion_Usuario_FK) }}"><br><br>
            </div>
